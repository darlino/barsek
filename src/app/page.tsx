...
export default function Home() {
  return (
    <main className="flex  min-h-screen container  max-w-4xl lg:max-w-6xl 2xl:max-w-7xl flex-col spac-y-2">
      <Navbar />
      <div className="flex flex-col lg:px-24 -space-y-20 p-8">
        ...
        <Link
          href="/dashboard"
          className="py-3 px-6 mx-auto group transition-all cursor-pointer p-4 text-white flex my-auto rounded-md space-x-3  bg-gradient-to-tr from-primary to-third"
        >
